...
import (
	...
	backendRemote "github.com/kevinklinger/open_terraform/noninternal/backend/remote"
	backendArtifactory "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/artifactory"
	backendAzure "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/azure"
	backendConsul "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/consul"
	backendCos "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/cos"
	backendGCS "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/gcs"
	backendHTTP "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/http"
	backendInmem "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/inmem"
	backendKubernetes "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/kubernetes"
	backendManta "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/manta"
	backendOSS "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/oss"
	backendPg "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/pg"
	backendS3 "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/s3"
	backendSwift "github.com/kevinklinger/open_terraform/noninternal/backend/remote-state/swift"
	backendCloud "github.com/kevinklinger/open_terraform/noninternal/cloud"
)
