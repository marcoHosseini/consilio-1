...
LDFLAGS="-X github.com/kevinklinger/open_terraform/noninternal/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/kevinklinger/open_terraform/noninternal/command/e2etest
