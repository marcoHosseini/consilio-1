...
[the `command` package](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/command).
...
[`backend.Operation`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/backend#Operation)
...
[`backend.Backend`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/backend#Backend), using a
mapping table in
[the `backend/init` package](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/backend/init).

Backends that are able to execute operations additionally implement
[`backend.Enhanced`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/backend#Enhanced);
...
[`local.Local`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/backend/local#Local),
...
(either
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states/statemgr#Filesystem) if the
...
[`terraform.Context`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#Context),
...
[`Plan`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#Context.Plan)
or
...
[package `configs`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/configs).
A whole configuration (the root module plus all of its descendent modules)
is represented by
[`configs.Config`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/configs#Config).
...
[`configload`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/configs/configload]),
via
[`configload.Loader`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/configs/configload#Loader).
...
[the `statemgr` package](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states/statemgr),
with most practical managers implementing the full set of operations
described by
[`statemgr.Full`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states/statemgr#Full)
...
The implementation
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states/statemgr#Filesystem) is used
...
[`states.State`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states#State)
...
[`GraphNodeConfigResource`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#GraphNodeConfigResource)
...
[`terraform.GraphTransformer`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#GraphTransformer).
...
* [`ConfigTransformer`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#ConfigTransformer),
  which creates a graph vertex for each `resource` block in the configuration.

* [`StateTransformer`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#StateTransformer),
  which creates a graph vertex for each resource instance currently tracked
  in the state.

* [`ReferenceTransformer`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#ReferenceTransformer),
...
* [`ProviderTransformer`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#ProviderTransformer),
...
[`terraform.Graph`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#Graph), which
...
[the low-level `dag` package](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/dag#AcyclicGraph.Walk)
(where "DAG" is short for [_Directed Acyclic Graph_](https://en.wikipedia.org/wiki/Directed_acyclic_graph)), in
[`AcyclicGraph.Walk`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/dag#AcyclicGraph.Walk).
However, the "interesting" Terraform walk functionality is implemented in
[`terraform.ContextGraphWalker`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#ContextGraphWalker),
...
* `EnterPath` is called once for each module in the configuration, taking a
  ...
  [`terraform.EvalContext`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#EvalContext)
...
[`states.SyncState`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/states#SyncState)
...
[`terraform.Execute`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/erraform#Execute).
...
[`terraform.BuiltinEvalContext`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#BuiltinEvalContext).
...
[`terraform.GraphNodeExecutable`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#GraphNodeExecutable),
...
* [NodePlannableResource.Execute](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#NodePlannableResourceInstance.Execute), which handles the `plan` operation.

* [`NodeApplyableResourceInstance.Execute`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#NodeApplyableResourceInstance.Execute), which handles the main `apply` operation.

* [`NodeDestroyResourceInstance.Execute`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#EvalWriteState), which handles the main `destroy` operation.
...
1. Analyze the configuration expressions to see which other objects they refer
  ...
  [`lang.References`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#References),
  or more often one of the helper wrappers around it:
  [`lang.ReferencesInBlock`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#ReferencesInBlock)
  or
  [`lang.ReferencesInExpr`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#ReferencesInExpr)
...
of the methods on [`lang.Scope`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#Scope);
most commonly,
[`lang.EvalBlock`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#Scope.EvalBlock)
or
[`lang.EvalExpr`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/lang#Scope.EvalExpr).
...
[`terraform.GraphNodeDynamicExpandable`](https://pkg.go.dev/github.com/kevinklinger/open_terraform/noninternal/terraform#GraphNodeDynamicExpandable).
